...
# Introduction
Spring Boot Application implementing CRUD with Hibernate and EclipseLink, you are free to pick which provider you
wanna use, both work fine :smiley:
...
- [Spring Boot + Spring Data JPA](https://github.com/melardev/SpringBootApiSpringJpaCrud)
